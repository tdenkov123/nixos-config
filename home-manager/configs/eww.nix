              ...
              (defwindow quicksettings
                ...
                (box :class "qs-root" :orientation "vertical" :spacing 14 :padding 14
                  ...
                  (box :class "qs-toggles" :spacing 8
                    (button :class "qs-toggle" :onclick "~/.local/bin/qs-wifi-toggle" 
                      (box :spacing 4 (label :text "Wi-Fi:") (label :text wifi_status)))
                    (button :class "qs-toggle" :onclick "~/.local/bin/qs-bt-toggle"
                      (box :spacing 4 (label :text "BT:") (label :text bt_status)))
                    (button :class "qs-toggle" :onclick "~/.local/bin/qs-vpn-toggle"
                      (box :spacing 4 (label :text "VPN:") (label :text vpn_status)))
                    (button :class "qs-toggle" :onclick "~/.local/bin/qs-airplane-toggle"
                      (label :text "Airplane")))
